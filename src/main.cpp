...
#define RXD2 16 // GPIO 16 (D16)
#define TXD2 17 // GPIO 17 (D17)
#define SERIAL_COMMUNICATION_CONTROL_PIN    4  // GPIO 4 (D4)
#define RS485_TX_PIN_VALUE  HIGH
#define RS485_RX_PIN_VALUE  LOW


// time server
const char*  MY_NTP_SERVER = "de.pool.ntp.org";      
const char*  MY_TZ = "CET-1CEST,M3.5.0/2,M10.5.0/3";
